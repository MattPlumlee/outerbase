...
Below is one correct deployment, where `mat25pow` is used for all dimensions.  This should take a bit to run, but it should be less than a minute on most modern computers.
```{r}
